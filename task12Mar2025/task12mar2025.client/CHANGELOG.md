...
- Create Angular project with ng: `ng new task12mar2025.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`task12mar2025.client.esproj`).
